...
public class kafkaV3ClustersClusterIdTopicsTopicNamePartitionsGetTest {
	...
	public void setUp() {
		...
		envList = dataloader.load(
				"src/test/java/org/springframework/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_name_partitionsGetTest.csv",
				envVarsList);
	}
           ...
           break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if (responseObj.statusCode() == 200) {
					System.out.println("Description: The list of partitions.");
				}
