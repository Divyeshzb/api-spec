...
public class kafkaV3ClustersClusterIdTopicsTopicNameDeleteTest {
	...
	public void setUp() {
		...
		envList = dataloader.load(
				"src/test/java/org/springframework/RoostTest/kafka_v3_clusters_cluster_id_topics_topic_nameDeleteTest.csv",
				envVarsList);
	}
          ...
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://api.confluent.cloud";
              ...
              if (testData.get("statusCode") != null) {
                MatcherAssert.assertThat(responseObj.statusCode(),
                 ...
                 List<Integer> expectedStatusCodes = Arrays.asList(204,400,401,403,404,429,5XX);
