...
Test generated for /kafka/v3/clusters/{cluster_id}/topics/-/configs_get for http method type GET in rest-assured framework

RoostTestHash=c7c723d9a1
...
public class kafkaV3ClustersClusterIdTopicsConfigsGetTest {
	...
	public void setUp() {
		...
		envList = dataloader.load(
				"src/test/java/org/springframework/RoostTest/kafka_v3_clusters_cluster_id_topics_-_configsGetTest.csv",
				envVarsList);
	}

	@Test
    public void kafkaV3ClustersClusterIdTopicsConfigsGet_Test() throws JSONException {
        this.setUp();
        ...
        for (Map<String, String> testData : envList) {
          RestAssured.baseURI = (testData.get("BASE_URL") != null && !testData.get("BASE_URL").isEmpty()) ? testData.get("BASE_URL"): "https://api.confluent.cloud";
              ...
              System.out.printf("Test Case %d: kafkaV3ClustersClusterIdTopicsConfigsGet_Test \n", testNumber++);
              System.out.println("Request: GET /kafka/v3/clusters/{cluster_id}/topics/-/configs");
           ...
           break;
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if (responseObj.statusCode() == 200) {
					System.out.println("Description: The list of cluster configs.");
				}
